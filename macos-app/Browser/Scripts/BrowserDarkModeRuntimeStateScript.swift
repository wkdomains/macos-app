          ...
          Object.defineProperty(window, "__wkdomainsDarkModeStatus", {
            ...
            value() {
              return {
                ...
                inlineVariableUpdateScheduled,
                inlineVariableUpdateBatches,
                inlineVariableUpdatesCompleted,
                ...
                legacyBackgroundDescendantScheduled,
                pendingLegacyBackgroundDescendants: legacyBackgroundDescendantQueue.length,
                legacyBackgroundDescendantBatches,
                legacyBackgroundDescendantsApplied,
                legacyBackgroundDescendantsCleared,
                elementApplyErrors,
